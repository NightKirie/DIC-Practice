...
module hcstratix_latch(D, ENA, PRE, CLR, Q);
...
module hcstratix_mux21 (MO, A, B, S);
   input A, B, S;
   output MO;
...
module hcstratix_mux41 (MO, IN0, IN1, IN2, IN3, S);
   input IN0;
   input IN1;
   input IN2;
   input IN3;
...
module hcstratix_bmux21 (MO, A, B, S);
   input [15:0] A, B;
   input 	S;
   output [15:0] MO; 
...
module hcstratix_b17mux21 (MO, A, B, S);
   input [16:0] A, B;
   input 	S;
   output [16:0] MO; 
...
module hcstratix_nmux21 (MO, A, B, S);
   input A, B, S; 
   output MO; 
...
module hcstratix_b5mux21 (MO, A, B, S);
   input [4:0] A, B;
   input       S;
   output [4:0] MO; 
...
module hcstratix_lcell_register (
                               clk, 
                               aclr, 
                               aload, 
                               sclr, 
    ...
    begin
        ...
        begin
            ...
            begin
                ...
                $display ("Error: Invalid operation_mode specified in hcstratix io atom!\n");
        end
...
`timescale 1 ps/1 ps
module hcstratix_mac_mult_internal 
  (
   dataa, 
   datab, 
   signa, 
...
`timescale 1 ps/1 ps
module hcstratix_mac_out_internal (dataa, datab, datac, datad, signx, signy, 
...
endmodule // hcstratix_ram_register
...
`timescale 1 ps/1 ps
  module hcstratix_ram_block 
   ...
   hcstratix_ram_clear ram_aclra_reg
     (
   ...
   hcstratix_ram_clear ram_aclrb_reg
     (
   ...
   hcstratix_ram_register	ram_portadatain_reg 
     (
   ...
   hcstratix_ram_register	ram_portaaddr_reg 
     (
   ...
   hcstratix_ram_register	ram_portawe_reg 
     (
      .data (portawe_delta),
      .clk (clk_bus[0]),
      .aclr(awe_aclr),
   ...
   hcstratix_ram_register	ram_portbdatain_reg 
     (
   ...
   hcstratix_ram_register	ram_portbaddr_reg 
     (
   ...
   hcstratix_ram_register	ram_portbrewe_reg 
     (
   ...
   hcstratix_ram_register	ram_portabyteenamasks_reg 
     (
   ...
   hcstratix_ram_register	ram_portbbyteenamasks_reg 
     (
   ...
   hcstratix_ram_internal internal_ram
     (
   ...
   hcstratix_ram_register	ram_portadataout_reg 
      (
   ...
   hcstratix_ram_register	ram_portbdataout_reg 
     (
...
module hcstratix_lvds_tx_parallel_register (clk, enable, datain, dataout, devclrn, devpor);
input [9:0] datain;
input clk;
input enable;
input devclrn;
...
endmodule //hcstratix_lvds_tx_register

`timescale 1 ps/1 ps

module hcstratix_lvds_tx_out_block (clk, datain, dataout, devclrn, devpor);
input datain;
input clk;
input devclrn;
input devpor;
...
module hcstratix_lvds_transmitter (clk0, enable0, datain, dataout, devclrn, devpor);
input [9:0] datain;
input clk0;
input enable0;
input devclrn;
...
hcstratix_lvds_tx_out_block output_module (.clk(clk0_dly2),
													  .datain(shift_out),
													  .dataout(dataout),
													  .devclrn(devclrn),
													  .devpor(devpor));
...
hcstratix_lvds_tx_parallel_register input_reg (.clk(txload0_dly),
															.enable(1'b1),
															.datain(datain_dly),
															.dataout(input_data),
															.devclrn(devclrn),
...
module hcstratix_lvds_rx_parallel_register (clk, enable, datain, dataout, devclrn, devpor);
input [9:0] datain;
input clk;
input enable;
input devclrn;
...
endmodule //hcstratix_lvds_rx_register

module hcstratix_lvds_receiver (clk0, enable0, enable1, datain, dataout, devclrn, devpor);
input datain;
input clk0;
input enable0;
input enable1;
...
hcstratix_lvds_rx_parallel_register load_reg (.clk(!clk0),
															.enable(rxload2_dly),
															.datain(shift_data),
															.dataout(load_data),
															.devclrn(devclrn),
...
//               loop feedback counter for the HCStratix PLL.
//
///////////////////////////////////////////////////////////////////////////////
...
//               input clock divide counter for the HCStratix PLL.
//
///////////////////////////////////////////////////////////////////////////////
...
begin
    ...
    begin
        $display (" Note : HCStratix PLL was reset");
        $display ("Time: %0t  Instance: %m", $time);
    end
    ...
    begin
        $display (" Note : HCStratix PLL was disabled");
        $display ("Time: %0t  Instance: %m", $time);
    end
       ...
       begin
          ...
          begin
              ...
              begin
                  ...
                  begin
                      ...
                      pll_about_to_lock = 0;
                      cycles_to_lock = 0;
                      $display ("Note : HCStratix PLL lost lock");
                      $display ("Time: %0t  Instance: %m", $time);
                      first_schedule = 1;
                      schedule_offset = 1;
                      vco_period_was_phase_adjusted = 0;
          ...
          begin
              ...
              begin
                  if (no_warn == 0)
                  begin
                      $display("Warning : Incoming clock period %d for HCStratix PLL does not match the specified inclock period %d. ALTGXB simulation may not function correctly.", refclk_period, primary_clock_frequency);
                      $display ("Time: %0t  Instance: %m", $time);
                      no_warn = 1;
                  end
              end
    ...
    begin
       ...
       begin
           ...
           begin
              ...
              if (l_pll_type == "fast")
                 locked_tmp = 1;
              $display ("Note : HCStratix PLL lost lock due to loss of input clock");
              $display ("Time: %0t  Instance: %m", $time);
           end
           pll_about_to_lock = 0;
           cycles_to_lock = 0;
...
//       else if (abs(fbclk_time - refclk_time) <= 2 || (refclk_period - abs(fbclk_time - refclk_time) <= 2))
       ...
       begin
           ...
           begin
              ...
              begin
                  $display (" Note : HCStratix PLL locked to incoming clock");
                  $display ("Time: %0t  Instance: %m", $time);
              end
              pll_is_locked = 1;
              locked_tmp = 1;
...
//--------------------------------------------------------------------
//
// Module Name : hcstratix_jtag
//
// Description : HCStratix JTAG Verilog Simulation model
//
//--------------------------------------------------------------------

`timescale 1 ps/1 ps
module  hcstratix_jtag (tms, tck, tdi, ntrst, tdoutap, tdouser, tdo, tmsutap, tckutap, tdiutap, shiftuser, clkdruser, updateuser, runidleuser, usr1user);
...
//--------------------------------------------------------------------
//
// Module Name : hcstratix_crcblock
//
// Description : HCStratix CRCBLOCK Verilog Simulation model
//
//--------------------------------------------------------------------
...
//---------------------------------------------------------------------
//
// Module Name : hcstratix_rublock
//
// Description : HCStratix RUBLOCK Verilog Simulation model
//
//---------------------------------------------------------------------
