...
//
///////////////////////////////////////////////////////////////////////////////
module  apexii_asynch_lcell (dataa, datab, datac, datad,
                      cin, cascin, qfbkin,
...
module  apexii_lcell_register (clk, aclr, sclr, sload, ena,
...
module apexii_asynch_io (datain, oe, regin, ddioregin, padio, combout, regout, ddioregout);
...
module apexii_io (datain, ddiodatain, oe, outclk, outclkena,
        ...
        input        inclk, inclkena, areset, devclrn;
        input        devpor, devoe;
        ...
        dffe    in_ddio0_reg (.Q (in_ddio0_reg_out),
                                .CLK (!inclk),
                                .ENA (inclkena),
                                .D (padio),
                                .CLRN (in_reg_clr && devclrn &&
        ...
        dffe    in_ddio1_reg (.Q (in_ddio1_reg_out),
                                .CLK (inclk),
                                .ENA (inclkena),
                                .D (in_ddio0_reg_out),
                                .CLRN (in_reg_clr && devclrn &&
        ...
        dffe    out_ddio_reg (.Q (out_ddio_reg_out),
                              .CLK (outclk),
                              .ENA (out_clk_ena),
                              .D (ddiodatain),
                              .CLRN (out_reg_clr && devclrn &&
        ...
        dffe    oe_pulse_reg (.Q (oe_pulse_reg_out),
                              .CLK (!outclk),
                              .ENA (oe_clk_ena),
                              .D (oe_reg_out),
                              .CLRN (oe_reg_clr && devclrn &&
...
`timescale 1 ps/1 ps
module  apexii_asynch_pterm (pterm0, pterm1, pexpin, fbkin, combout, 
			     pexpout, regin);
...
`timescale 1 ps/1 ps
module  apexii_pterm_register (datain, clk, ena, aclr, devclrn, devpor,
                            regout, fbkout);
    parameter power_up    = "low";
...
module apexii_ram_block (portadatain,
    ...
    dffe    portawaddrreg_16  (portawaddr_reg[16], 
                               portaclk0, 
                               portaena0, 
                               portawaddr[16], 
                               portawaddr_reg_clr && devclrn && devpor, 
    ...
    dffe    portaraddrreg_16  (portaraddr_reg[16], 
                               portaraddr_clk,
                               portaraddren, 
                               portaraddr[16],
                               portaraddr_reg_clr && devclrn && devpor, 
    ...
    dffe    portbwaddrreg_16   (portbwaddr_reg[16], 
                                portbclk0, 
                                portbena0, 
                                portbwaddr[16], 
                                portbwaddr_reg_clr && devclrn && devpor, 
    ...
    dffe    portbraddrreg_16   (portbraddr_reg[16], 
                                portbraddr_clk,
                                portbraddren, 
                                portbraddr[16],
                                portbraddr_reg_clr && devclrn && devpor, 
...
module apexii_hsdi_transmitter (clk0, clk1, datain, dataout, devclrn, devpor);
input [9:0] datain;
input clk0;
input clk1;
input devclrn;
...
`timescale 1 ps/1 ps
module  apexii_jtagb (tms, tck, tdi, ntrst, tdoutap, tdouser, tdo, tmsutap, tckutap, tdiutap, shiftuser, clkdruser, updateuser, runidleuser, usr1user);
